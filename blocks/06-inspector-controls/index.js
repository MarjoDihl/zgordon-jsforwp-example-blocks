...
const { __ } = wp.i18n;
const {
    registerBlockType, // found in gutenberg/blocks/api/registration.js
    // the following are in gutenberg/editor/components
    RichText,
    AlignmentToolbar,
    BlockControls,
...
const { // these are in gutenberg/components
    Toolbar,
    Button,
    Tooltip,
    PanelBody,
